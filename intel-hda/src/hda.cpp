...
#ifdef NEUTRINO_DYNAMIC_MODULE_INTEL_HDA
...
bool register_module() {
    register_driver();
    static const audio_output::Ops output_ops{
        .available = available,
        .write_pcm = write_pcm,
        .drain = drain,
        .flush = flush,
    ...
    return audio_output::register_provider("intel-hda", &output_ops);
}

#ifndef NEUTRINO_DYNAMIC_MODULE_INTEL_HDA
